...
namespace QuanLyHocSinh
{
    public partial class frmLSGD : Form
    {
        ...
        private void frmLSGD_Load(object sender, EventArgs e)
        {
            loadLSGD();
        ...
        public void loadLSGD()
        {
            try
            {
                ...
                foreach (var hphi in db.ShowLSGD())
                {
                    dgvHocPhi.Rows.Add();
                    ...
                    dgvHocPhi.Rows[index].Cells[6].Value = hphi.NgayGD.Value.ToString("dd/MM/yyyy");
                    index++;
                }
            }
            catch (Exception ex)
